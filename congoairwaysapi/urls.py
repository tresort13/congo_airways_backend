...
urlpatterns = [
    ...
    path('passager_info/<int:pk>', views.passager_informations_detail),
    ...
    path('api/bagageAutoQuery/<int:pk>/',views.bagageAutoQuery,name='bagageAutoQuery'),
    path('api/passagerAutoQuery/<int:pk>/',views.passagerAutoQuery,name='passagerAutoQuery'),
